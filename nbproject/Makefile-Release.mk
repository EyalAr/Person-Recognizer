...
${OBJECTDIR}/PersonRecognizer.o: PersonRecognizer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/PersonRecognizer.o PersonRecognizer.cpp

${OBJECTDIR}/CsvWriter.o: CsvWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/CsvWriter.o CsvWriter.cpp

${OBJECTDIR}/FramesReader.o: FramesReader.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/FramesReader.o FramesReader.cpp
...
${OBJECTDIR}/FaceDetector.o: FaceDetector.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/FaceDetector.o FaceDetector.cpp

${OBJECTDIR}/PrepareFaces.o: PrepareFaces.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/PrepareFaces.o PrepareFaces.cpp

${OBJECTDIR}/FramesWriter.o: FramesWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/FramesWriter.o FramesWriter.cpp
